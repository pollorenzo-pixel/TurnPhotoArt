...
const userMessage: Record<string, string> = {
  generation_paused: "Artwork generation is paused for this private test.", generation_limit_reached: "Three artwork versions have already been created.", set_generation_active: "This artwork set already has a generation in progress.", session_generation_active: "Another generation is already in progress in this test session.", moderation_blocked: "This request could not be completed by the safety system. Try adjusting the optional details.", provider_timeout_unknown: "The provider response is uncertain. Please do not retry yet; the reservation needs review.", daily_request_limit: "The private test has reached its daily request limit.", hourly_ip_limit: "Please wait before creating another version.", daily_cost_limit: "The private test has reached its cost-safety limit.", global_concurrency_reached: "Another private generation is currently running. Try again later.", reference_mismatch: "This artwork set is locked to its original reference photo.", personality_too_long: "Keep the optional personality details to 160 characters.",
};
